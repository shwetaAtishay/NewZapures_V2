...
namespace NewZapures_V2.Models
{
    public class SessionModel : HttpSessionStateBase
    {
        ...
        public static string TrustName
        {
            get
            {
                if (HttpContext.Current.Session["_TrustName"] != null)
                    return HttpContext.Current.Session["_TrustName"].ToString();
                else
                    return "";
            }
            set
            {
                HttpContext.Current.Session["_TrustName"] = value;
            }
        }

        public static string TrustTypeName
        {
            get
            {
                if (HttpContext.Current.Session["TrustTypeName"] != null)
                    return HttpContext.Current.Session["TrustTypeName"].ToString();
                else
                    return "";
            }
            set
            {
                HttpContext.Current.Session["TrustTypeName"] = value.ToString();
            }
        }

...
namespace NewZapures_V2.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public ActionResult OldNOC(string clgID = "")
        {
            ...
            ViewBag.EntryForCLG = clgID;
            ViewBag.sessionYears = sessionYearList;
            return View();
        }
        public ActionResult OldNOC1(string clgID = "", string guid = "")
        {
            var collegeList = ZapurseCommonlist.GetColleges();
            var sessionYearList = ZapurseCommonlist.GetSessionYears();
        ...
        {
            var collegeList = ZapurseCommonlist.GetCoursesForCollegeOLDNOC1(clgID);
        ...
        public JsonResult GetSubjectForCourse(string courseID, string clgID)
        {
            var collegeList = ZapurseCommonlist.GetSubjectForCourseOldNOC1(courseID, "GetSubjectForCourseOLDNOC1", clgID);
        ...
        public JsonResult GetCourseAndSubject(string clgID)
        {
            var collegeList = ZapurseCommonlist.GetCourseAndSubject(clgID, "GetSubjectForCourseOLDNOC");
        ...
        public JsonResult GetOldNOCDataForCLG(string clgID)
        {
            var OldNOCdataForCLG = ZapurseCommonlist.GetOldNOCDataForCLG(clgID);

            return new JsonResult
            {
                Data = new { Data = OldNOCdataForCLG, failure = true, msg = "success" },
                ContentEncoding = System.Text.Encoding.UTF8,
                JsonRequestBehavior = JsonRequestBehavior.AllowGet
            };
        }

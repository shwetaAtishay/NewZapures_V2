...
namespace NewZapures_V2.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public JsonResult getSSODetails(string ssoID)
        {
            var jsonUserDetail = "";
            ...
            Models.SSOUserDetail _SSOUserDetail = new Models.SSOUserDetail();
            using (RAJSSO.SSO SSO = new RAJSSO.SSO(AppName))
            {
                try
                {
                    RAJSSO.SSOUserDetail UserDetail = SSO.GetUserDetail(ssoID, WebServiceUser, WebServicePwd);
                    if (UserDetail != null)
                    {
            ...
            return new JsonResult
            {
                Data = new { Data = jsonUserDetail, failure = false, msg = "Success", isvalid = 1 },
                ContentEncoding = System.Text.Encoding.UTF8,
                JsonRequestBehavior = JsonRequestBehavior.AllowGet
            };
        }
